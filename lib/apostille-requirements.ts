...
export const APOSTILLE_GENERAL_DEFAULT: Record<Track, ApostilleGeneralDefault> = {
  ...
  gks_u: {
    summary: [
      "For the 2027 GKS-U Embassy Track first round, required certificates are uploaded as scanned copies online. Apostille or consular confirmation is not required at this first submission stage.",
      "If you pass the first round, the required certificates for NIIED's second round must generally be apostilled or consular confirmed.",
      "Application forms themselves do not need apostille or consular confirmation.",
      "Documents not written in English or Korean require a certified translation; follow the guideline's authentication rule for the original or certified translation.",
      "A simple photocopy or ordinary notarized copy is not a substitute for the authenticated document required at the second round.",
    ],
    documentsRequiringAuthentication: {
      note: "2027 GKS-U second-round rule: authenticate the required certificates submitted to NIIED after passing the first round. Conditional certificates apply only when relevant to the applicant.",
      gksU: [
        { no: "citizenship", name: "Proof of citizenship and family relationship (applicant and parents/legal guardians)", requirement: "Required" },
        { no: "hs-grad", name: "High School Graduation Certificate (or final graduation certificate for expected graduates)", requirement: "Required" },
        { no: "hs-transcript", name: "Academic transcript of the high school curriculum", requirement: "Required" },
        { no: "associate-grad", name: "Associate-degree graduation certificate, when applicable", requirement: "Optional" },
        { no: "associate-transcript", name: "Associate-degree transcript, when applicable", requirement: "Optional" },
        { no: "special-status", name: "Other citizenship/status certificates required for a claimed special category, when applicable", requirement: "Optional" },
      ],
    },
    documentsNotRequiringAuthentication: {
      forms: [
      ...
      otherOptional: [
        "TOPIK / TOEFL / IELTS score report",
        "Awards and other activity or achievement certificates",
        "Passport copy",
      ],
    },
    sources: [
      {
        label: "2027 GKS-U Application Guidelines — official NIIED / Study in Korea notice",

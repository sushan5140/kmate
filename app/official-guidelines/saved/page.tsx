...
export default async function SavedGksRulesPage() {
  await requireOnboarded("/official-guidelines/saved");
      ...
      <div className="mt-5 flex items-start gap-3">
        ...
        <div>
          ...
          <h1 className="mt-1 text-[22px] font-semibold text-ink">
            Your bookmarked guideline rules and AI answers
          </h1>
          <p className="mt-1 max-w-2xl text-[12.75px] leading-relaxed text-muted">
            Saved items are stored only in this browser. They are a personal reference list, not a replacement for the current official guideline.
          </p>
        </div>
      </div>
